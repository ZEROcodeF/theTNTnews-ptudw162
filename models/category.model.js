...
module.exports = {
  ...
  updateChildCatToParentCat: parentCatId => {
    return db.updateSelf('category','category_parent',parentCatId,0);
  },
  ...
  deleteCateInChargeWithCategoryId : catId =>{
    return db.delete('categoryeditor','categoryeditor_category',catId);
  }
};